...
if __name__ == "__main__":
    ...
    # 1、帽子头发胡子的类别
    classes1 = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow', 'diningtable', 'dog',
        'horse', 'motorbike', 'person', 'pottedplant', 'sheep', 'sofa', 'train', 'tvmonitor']
    # 2、voc格式的xml标签文件路径
    xml_files1 = r'G:\Fundamental\VOCdevkit\VOC2012\Annotations'
    # 3、转化为yolo格式的txt标签文件存储路径
    save_txt_files1 = r'G:\Fundamental\VOCdevkit\VOC2012\labels'
